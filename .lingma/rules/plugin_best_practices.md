...
## 插件结构规范
MoviePilot插件开发需包含__init__.py（主程序）、README.md（说明文档）基础文件，插件目录放置于plugins/下


## 官方插件仓库
Official MoviePilot repositories:
- @MoviePilot: Main backend repository
- @MoviePilot-Frontend: Frontend repository
- @MoviePilot-Plugins: Official plugins repository
- @MoviePilot-Resources: Site resources repository
- @openapi.json: Official API documentation
